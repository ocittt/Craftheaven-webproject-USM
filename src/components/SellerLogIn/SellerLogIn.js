...
import "./SellerLoginFormStyle.css";
...
const SellerLogin = () => {
  ...
  const onLogin2 = () => {
    ...
    signInWithEmailAndPassword(auth, email, password)
      .then((userCredential) => {
        ...
        const dt = new Date();
        update(ref(db, "Sellers/" + user.uid), {
          last_login: dt,
        });
  ...
  return (
    <div className="login-body">
      ...
      <div>
        <button className="cust-form" onClick={custlog}>
          Customer
        </button>
        <button className="seller-form" onClick={sellerlog}>
          Seller
        </button>
      </div>
      <div className="login-form">
        <p className="login-title">Seller Login</p>
        <div className="login-form-inner">
          ...
          <br></br>
          <div className="login-form-group">
            <img className="passkey-logo3" src={passkey} alt="Password logo" />
            <input
              size="60"
              className="login-inputs"
              type="password"
          ...
          <br></br>
          <button className="login-btn" value="Sign In" onClick={onLogin2}>
            Sign In
          </button>
          <br></br>
        </div>
